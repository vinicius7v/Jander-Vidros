    ...
    <div className="bg-white rounded-lg shadow-lg">
      <div className="p-4 border-b">
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="Buscar por produto, categoria ou fornecedor..."
            value={searchTerm}
        ...
        <table className="w-full">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Preço Compra</th>
                ...
                return (
                  <tr key={product.id} className={isLowStock ? 'bg-orange-50' : ''}>
                    ...
                    <td className="px-6 py-4">
                      ...
                      {product.minStock > 0 && (
                        <span className="text-xs text-gray-500 ml-1">(mín: {product.minStock})</span>
                      )}
                    </td>
